      ...
      <div className="grid grid-cols-1 lg:grid-cols-[62%_1fr] relative">
        ...
        <div className="border-r border-[#2b2b2b] flex flex-col">
          <div className="p-12 lg:p-24 pb-8 border-b border-[#2b2b2b]">
            <p className="text-[11px] tracking-[0.4em] uppercase text-white/20 mb-4">Get in Touch</p>
            <h2 className="text-4xl md:text-5xl font-black text-white">Let&apos;s build the future.</h2>
          </div>
          ...
          <div className="p-12 lg:p-24">
            ...
            <div className="flex gap-10 items-center text-xs font-bold tracking-[0.2em] text-zinc-500 uppercase">
